pipeline {
    ...
    stages {
        ...
        stage("deploy on container through ansible") {
            steps {
                ansiblePlaybook credentialsId: 'ansibleCred', disableHostKeyChecking: true, extras: 'DOCKERIMAGETAG=${DOCKERIMAGETAG}', installation: 'ansible', inventory: 'dev.inv', playbook: 'deploy-docker.yml'
            }
